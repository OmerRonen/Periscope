...
from ..utils.utils import yaml_save, yaml_load
...
def main():
    ...
    params = yaml_load(os.path.join(PATHS.periscope, 'models', original_model, 'params.yml'))
    model_path = os.path.join(PATHS.periscope, 'models', new_model)
